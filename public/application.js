...
/***/ (function(module, exports, __webpack_require__) {
	...
	var birthdayEvents = __webpack_require__(12);
	var birthdayUi = __webpack_require__(14);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://pacific-brushlands-38706.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  displayChangePassModal: displayChangePassModal,
	  onClosePassModal: onClosePassModal
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(8);
	var birthdayApi = __webpack_require__(13);
	var birthdayUi = __webpack_require__(14);
	...
	var displayAddBirthdayModal = function displayAddBirthdayModal(event) {
	...
	var createNewBirthday = function createNewBirthday(event) {
	  event.preventDefault();
	  ...
	  if (birthday.given_name.length !== 0 && birthday.born_on.length !== 0) {
	    birthdayApi.createBirthday(data).then(birthdayUi.createBirthdaySuccess).catch(birthdayUi.onError);
	  }
	};

	// function to update birthday when save changes button is pressed inside update birthday modal
	var updateBirthday = function updateBirthday(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var birthday = data.birthday;
	  var id = $('.update-birthday-btn').data('id');
	  // console.log(id, data)
	  if (birthday.given_name.length !== 0 && birthday.born_on.length !== 0) {
	    birthdayApi.patchBirthday(id, data).then(birthdayUi.onSuccessPatchBirthday).catch(birthdayUi.onError);
	  }
	};

	var onClearBirthdays = function onClearBirthdays(event) {
	  event.preventDefault();
	...
	module.exports = {
	  // displayAllBirthdays,
	  displayAddBirthdayModal: displayAddBirthdayModal,
	  createNewBirthday: createNewBirthday,
	  updateBirthday: updateBirthday,
	  // hideMessages,
	  onClearBirthdays: onClearBirthdays
	  // getBirthdaysThirtyDays
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// show all birthdays
	var indexBirthdays = function indexBirthdays() {
	  return $.ajax({
	...
	// get one birthday
	var showBirthday = function showBirthday(id) {
	  return $.ajax({
	...
	// create one birthday
	var createBirthday = function createBirthday(data) {
	  return $.ajax({
	    method: 'POST',
	    url: config.apiOrigin + '/birthdays/',
	    headers: {
	...
	var destroyBirthday = function destroyBirthday(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/birthdays/' + id,
	    method: 'DELETE',
	    headers: {
	...
	var patchBirthday = function patchBirthday(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/birthdays/' + id,
	    method: 'PATCH',
	    headers: {
	...
	module.exports = {
	  indexBirthdays: indexBirthdays,
	  showBirthday: showBirthday,
	  createBirthday: createBirthday,
	  destroyBirthday: destroyBirthday,
	  patchBirthday: patchBirthday
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showAllBirthdaysTemplate = __webpack_require__(15);
	var showOneBirthdayTemplate = __webpack_require__(35);
	var birthdayApi = __webpack_require__(13);
	...
	var displayAllBirthdays = function displayAllBirthdays() {
	  console.log('display all birthdays ran');
	  birthdayApi.indexBirthdays().then(onSuccessDisplayBirthdays).catch(onError);
	};

	//bday success
	var onSuccessDisplayBirthdays = function onSuccessDisplayBirthdays(data) {
	  //  console.log('show bdays was successful' + data.birthdays)
	  var showAllBirthdays = showAllBirthdaysTemplate({ birthdays: data.birthdays });
	...
	var createBirthdaySuccess = function createBirthdaySuccess(data) {
	  ...
	  var addOneBirthday = showOneBirthdayTemplate({ birthday: data.birthday });
	...
	// remove birthday
	var removeBirthday = function removeBirthday(data) {
	  event.preventDefault();
	  // console.log('remove birthday button was pressed')
	  $(this).closest('ul').remove();
	  var id = $(this).data('id');
	  birthdayApi.destroyBirthday(id).then(onSuccessRemoveBirthday).catch(onError);
	};

	var onSuccessRemoveBirthday = function onSuccessRemoveBirthday(event) {
	  // console.log('remove birthday successful was ran')
	  getUpcomingBirthdays();
	};

	// update birthday modal
	var displayUpdateBirthdayModal = function displayUpdateBirthdayModal(event) {
	  event.preventDefault();
	  var id = $(this).data('id');
	  // console.log('update birthday button was pressed' + id)
	  $('#update-birthday-modal').modal({ show: true });
	  birthdayApi.showBirthday(id).then(onSuccessPreFillBirthdayFields).catch(onError);
	};

	var onSuccessPatchBirthday = function onSuccessPatchBirthday(data) {
	  // console.log('patch birthday success ran', data)
	  $('.birthday-updated-message').show();
	};

	var onSuccessPreFillBirthdayFields = function onSuccessPreFillBirthdayFields(data) {
	...
	var clearBirthdays = function clearBirthdays() {
	  $('.content').empty();
	};

	// get birthdays in the next 30 days
	var getUpcomingBirthdays = function getUpcomingBirthdays() {
	  // console.log('upcoming Birthdays function ran')
	  birthdayApi.indexBirthdays().then(onSuccessStats).catch(onError);
	};
	...
	var onSuccessStats = function onSuccessStats(data) {
	  ...
	  var birthdaysOnly = data.birthdays.map(function (a) {
	    return a.born_on;
	  });
	  // function to take a string and change to a date
	  var birthdaysAsDates = birthdaysOnly.map(function (a) {
	    return new Date(a);
	  });
	  // create a new object that stores months, day and year as individuval keys
	  var birthdayMonthDay = birthdaysAsDates.map(function (a) {
	    return {
	      month: a.getMonth() + 1,
	      day: a.getDate(),
	...
	module.exports = {
	  onSuccessDisplayBirthdays: onSuccessDisplayBirthdays,
	  onError: onError,
	  createBirthdaySuccess: createBirthdaySuccess,
	  displayUpdateBirthdayModal: displayUpdateBirthdayModal,
	  onSuccessRemoveBirthday: onSuccessRemoveBirthday,
	  onSuccessPatchBirthday: onSuccessPatchBirthday,
	  clearBirthdays: clearBirthdays,
	  onSuccessStats: onSuccessStats,
	  displayAllBirthdays: displayAllBirthdays,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n\n   <!-- use data-id not just id-->\n   <ul class = 'birthdays-list' data-id=\""
	    ...
	    + " </li>\n     <button type=\"submit\" class = \"btn btn-primary remove-birthday-btn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"button\">Remove</button>\n     <button type=\"button\" class = \"btn btn-primary update-birthday-btn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"button\">Update</button>\n   </ul>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.birthdays : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<ul class = 'birthday-list' data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.birthday : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n <li> Name: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.birthday : depth0)) != null ? stack1.given_name : stack1), depth0))
	    + " "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.birthday : depth0)) != null ? stack1.family_name : stack1), depth0))
	    + " </li>\n  <li> Birthday: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.birthday : depth0)) != null ? stack1.born_on : stack1), depth0))
	    + " </li>\n  <button type=\"submit\" class = \"btn btn-primary remove-birthday-btn\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.birthday : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"button\">Remove</button>\n  <button type=\"button\" class = \"btn btn-primary update-birthday-btn\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.birthday : depth0)) != null ? stack1.id : stack1), depth0))
